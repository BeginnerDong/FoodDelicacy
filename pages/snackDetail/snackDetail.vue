<template>
	<view>
		...
		<view class="detailTBj pr">
			...
			<view class="balckIcon" @click="back()"><image src="../../static/images/arrowL.png" mode=""></image></view>
		</view>
		
		<view class="mglr4 detail-name pdlr4 pdt10 pdb10 whiteBj radius10 boxShaow">
			<view class="flexRowBetween">
				<view class="name fs15 ll ">老火锅小吃城(雁塔区)</view>
				<view class="rrBtn fs12 color6 flexEnd">
					<view class="btn mgr10" :class="selCurr==1?'on':''" @click="selCurrChange('1')">菜品</view>
					<view class="btn" :class="selCurr==2?'on':''" @click="selCurrChange('2')">档口</view>
				</view>
			</view>
			...
			<view class="flexRowBetween mgt5">
				<view class="flex fs13">
					<image class="shopIcon mgr5" src="../../static/images/home-icon4.png" mode=""></image>
					<view>快餐小吃</view>
				</view>
				<view class="flexEnd fs11  color9">37分钟<span class="mgl10">2.4km</span></view>
			</view>
		</view>
		...
		<view class="pdlr4 mgt15 foodList" v-show="selCurr==1">
			<view class="item" v-for="(item,index) in mainData" :key="index">
				<view class="nameLable">档口名称</view>
		...
		<!-- 结算固定按钮 -->
		<view class="fixB-radius">
			<view class="flex left">
				<view class="icon mgl20">
					<image src="../../static/images/detailsl-icon.png" mode=""></image>
					<view class="num">1</view>
				</view>
				<view class="mgl20 white fs16 ftw">￥59</view>
			</view>
			<view class="payBtn fs15" @click="Router.navigateTo({route:{path:'/pages/orderConfim/orderConfim'}})">去结算</view>
		</view>
