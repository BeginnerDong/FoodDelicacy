<template>
	<view>
			<view class="myaddress-lis" v-for="(item,index) in myaddressDate" :key="index">
				...
				<view class="seltBox">
					<view class="L"  @click="seltCurr(index)">
						<image class="icon" :src="curr == index?'../../static/images/addressl-icon.png':'../../static/images/addressl-icon3.png'"  mode=""></image>
						默认地址
					</view>
			...
			<view class="submitbtn" style="margin-top: 200rpx;" @click="Router.navigateTo({route:{path:'/pages/user_addressAdd/user_addressAdd'}})">
