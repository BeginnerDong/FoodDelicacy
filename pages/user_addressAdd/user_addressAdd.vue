	...
	<view class="">
		<view class="myRowBetween">
			...
			<view class="item flexRowBetween pdtb15 borderB1">
				...
				<view class="rr">
					<switch style="transform:scale(0.75);" color="#FCC401" />
				</view>
			</view>	
			
			<view class="submitbtn pdtb15"  style="margin-top: 200rpx;">
				<button class="btn" type="button"  @click="Router.navigateTo({route:{path:'/pages/user_address/user_address'}})">确认</button>
			</view>
